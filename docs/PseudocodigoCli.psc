Proceso cli
	// Enviar mensaje con instrucción en CLI.
	Escribir 'Ingrese ruta a testear. Formato: md-links <ruta-a-archivo> [opciones] ';
	...
	SiNo
		...
		Escribir 'Error: No se ha ingresado ruta en cli. Ej: md-links ../carpeta ';
	FinSi
FinProceso
